...
model_name = f"LabelSampler_augmentation1_{time.strftime('%Y%m%d_%H%M%S')}"
...
transform = tio.Compose([
    ...
    tio.RandomAffine(scales=0.5, degrees=90, default_pad_value="otsu"),
    tio.RandomBlur((0.2, 0.7)),
